...
// Bind unlinked customer rows to a WordPress account at registration time. This
// is the only automatic binding left: an email change alone never claims a row.
$app->addAction('user_register', '\FluentSupport\App\Services\ProfileInfoService@onWPUserRegister', 10, 1);
