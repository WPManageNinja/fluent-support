...
class ResponseService
{
    ...
    public function createResponse($data, $person, $ticket, $silently = false)
    {
        ...
        // Request input is unslashed once at the boundary (the framework Request
        // cleaner for web requests, WP core for REST params), and API, MCP and
        // webhook callers pass decoded JSON that was never slashed. Sanitize only:
        // unslashing again would strip literal backslashes out of Windows paths,
        // regexes, JSON and shell snippets.
