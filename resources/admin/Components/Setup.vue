...
export default {
        ...
        completeSetup() {
            ...
            this.$post('settings/setup', {
                ...
                .then(response => {
                    ...
                    // The site now has an inbox; without this the dashboard bounces
                    // straight back here until the next full page load.
                    this.appVars.has_mailboxes = true;
    ...
    mounted() {
        // Onboarding is only for users who can actually complete it -- the setup REST
        // routes are fst_manage_settings-gated. Anyone else lands on the dashboard,
        // including agents who reach #/setup directly.
        if (this.appVars.has_mailboxes || !this.canManageSettings) {
